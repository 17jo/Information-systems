...
public class Zahtev{
	...
	@Id
	@Column(name="idzahteva", nullable = false, updatable = false)
	...
	public Zahtev(int brojpasosa, String namena,int trajanje, String status) throws IOException {
...
//	public Zahtev(int brojpasosa, String namena,int trajanje) throws IOException {
//		this.setBrojpasosa(brojpasosa);
//		this.setNamena(namena);
//		this.setTrajanje(trajanje);
